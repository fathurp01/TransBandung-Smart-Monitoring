...
- **Key phases**:
  ...
  2. Terraform infrastructure provisioning (15 min)
...
#### 4. [TERRAFORM_ECS_SETUP.md](TERRAFORM_ECS_SETUP.md) — ECS INFRASTRUCTURE
- **Audience**: Terraform engineers, infrastructure architects
- **Content**: Complete Terraform configuration untuk ECS cluster, task definition, ALB, IAM roles
- **Time to read**: 15 minutes
- **Prerequisite**: Terraform sudah installed, AWS account ready
- **Key sections**:
...
- **Key sections**:
  ...
  3. Create S3 backend bucket untuk Terraform state
  4. Update Terraform backend config
  ...
  7. Manual atau automated Terraform deployment
...
1. Start: TERRAFORM_ECS_SETUP.md → Infrastructure code
...
3. Verify: TERRAFORM_ECS_SETUP.md → IAM roles + security groups
...
3. Config: TERRAFORM_ECS_SETUP.md (15 min)
...
│   ├── TERRAFORM_ECS_SETUP.md                ← Infrastructure code
...
| **I need to configure Terraform** | TERRAFORM_ECS_SETUP.md | 15 min |
...
- [ ] TERRAFORM_ECS_SETUP.md code sudah valid
...
- **Questions about infrastructure?** → TERRAFORM_ECS_SETUP.md
